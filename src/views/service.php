    ...
    <div class="container">
        <div class="row">
            ...
            <div class="service-box col-md-12">
                <div class="row">
                    <div class="col-md-6">
                        <img class="img-responsive" src="<?php echo RESOURCES_PATH; ?>images/services/service-one.jpg" alt="service-image">
                    </div>
                    <div class="col-md-6">
                        <div class="contents">
        ...
        <div class="row items-container clearfix">
            ...
            <div class="item">
                <div class="inner-box">
                    <div class="img_holder">
                        <a href="service.php">
                            <img src="<?php echo RESOURCES_PATH; ?>images/gallery/<?php echo '1'; ?>.jpg" alt="service <?php echo '1'; ?>" class="img-responsive">
                        </a>
                    </div>
            ...
            <div class="item">
                <div class="inner-box">
                    <div class="img_holder">
                        <a href="service.php">
                            <img src="<?php echo RESOURCES_PATH; ?>images/gallery/<?php echo '2'; ?>.jpg" alt="service <?php echo '2'; ?>" class="img-responsive">
                        </a>
                    </div>
                    <div class="image-content text-center">
                        <span>Better Service At Low Cost</span>
            ...
            <div class="item">
                <div class="inner-box">
                    <div class="img_holder">
                        <a href="service.php">
                            <img src="<?php echo RESOURCES_PATH; ?>images/gallery/<?php echo '3'; ?>.jpg" alt="service <?php echo '3'; ?>" class="img-responsive">
                        </a>
                    </div>
                    <div class="image-content text-center">
                        <span>Better Service At Low Cost</span>
            ...
            <div class="item">
                <div class="inner-box">
                    <div class="img_holder">
                        <a href="service.php">
                            <img src="<?php echo RESOURCES_PATH; ?>images/gallery/1.jpg" alt="images" class="img-responsive">
                        </a>
                    </div>
                    <div class="image-content text-center">
                        <span>Better Service At Low Cost</span>
            ...
            <div class="item">
                <div class="inner-box">
                    <div class="img_holder">
                        <a href="service.php">
                            <img src="<?php echo RESOURCES_PATH; ?>images/gallery/2.jpg" alt="images" class="img-responsive">
                        </a>
                    </div>
                    <div class="image-content text-center">
                        <span>Better Service At Low Cost</span>
            ...
            <div class="item">
                <div class="inner-box">
                    <div class="img_holder">
                        <a href="service.php">
                            <img src="<?php echo RESOURCES_PATH; ?>images/gallery/3.jpg" alt="images" class="img-responsive">
                        </a>
                    </div>
                    <div class="image-content text-center">
                        <span>Better Service At Low Cost</span>
