...
<!--Page Title-->
<section class="page-title text-center" style="background-image:url(/resources/images/background/3.jpg);">
    <div class="container">
            ...
            <div class="col-md-9 col-sm-12 col-xs-12">
                <div class="left-side">
                    <div class="item-holder">
                        <div class="image-box">
                            <figure>
                                <a href="single-blog.php"><img src="<?php echo RESOURCES_PATH; ?>images/blog/5.jpg" alt=""></a>
                            </figure>
                        </div>
