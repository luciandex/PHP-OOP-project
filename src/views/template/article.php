...
<section class="blog-section section style-four style-five">
    <div class="container">
        <div class="row">
            <div class="col-md-9 col-sm-12 col-xs-12">
                <div class="left-side">
                    <div class="item-holder">
                        <div class="image-box">
                            <figure>
                                <a href="#"><img src="<?php echo RESOURCES_PATH; ?>images/blog/5.jpg<?php //$article->getImage(); ?>" alt=""></a>
                            </figure>
                        </div>
                        <div class="content-text">
                            <a href="#"><h5>A LESSON IN SURGERY PREPAREDNESS - FROM HURRICANE SEASON<?php //$article->getTitle(); ?></h5></a>
                            <span>By Donult Trump <?php //$article->getAuthor(); ?>/ 02 January 2018<?php //$article->getCreatedAt(); ?></span>
                ...
                <div class="comments-area">
                    ...
                    <div class="comment">
                        <div class="image-holder">
                            <figure>
                                <img src="<?php echo RESOURCES_PATH; ?>images/blog/1.png" alt="">
                            </figure>
                        </div>
                    ...
                    <div class="comment reply-comment">
                        <div class="image-holder">
                            <figure>
                                <img src="<?php echo RESOURCES_PATH; ?>images/blog/2.png" alt="">
                            </figure>
                        </div>
                        <div class="image-text">
                    ...
                    <div class="comment">
                        <div class="image-holder">
                            <figure>
                                <img src="<?php echo RESOURCES_PATH; ?>images/blog/3.png" alt="">
                            </figure>
                        </div>
                        <div class="image-text">
            ...
            <?php include_once 'side-bar-blog.php'; ?>
